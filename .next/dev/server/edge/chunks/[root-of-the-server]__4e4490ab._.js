...
async function updateSession(request) {
    ...
    try {
        ...
        if (error) {
            if (error.message.includes("User from sub claim in JWT does not exist")) {
                ...
                const response = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$web$2f$exports$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL("/auth/login", request.url));
    ...
    if (!user && !request.nextUrl.pathname.startsWith("/auth") && !request.nextUrl.pathname.startsWith("/browse") && request.nextUrl.pathname !== "/") {
